...
epochs = int(sys.argv[6]) if len(sys.argv) > 6 else 400000
...
for t in timeList:
    issm = {}
    issm["data_size"] = {"u":3000, "v":3000, "a":3000, "H":None, 's':3000}
...
# physics
Time_Invariant = {}
Time_Invariant["pde_weights"] = [10**dt0weights, 0]
Thickness = {}
Thickness["pde_weights"] = [10**pdeweights]
hp["equations"] = {"Thickness": Thickness, "Time_Invariant": Time_Invariant}
